# -*- coding: utf-8 -*-
"""Using_Adaboost_classifier_Course Project 1.ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1UowvqgUNcdMmYP4dqb9ohhBfbjvKnQ4Y
"""
...
# ======================================================================
# CELL 6: TRAIN ADABOOST MODEL
# ======================================================================
# Now we train our model on the training data

print("\nStep 5: Training AdaBoost model...")
...
print(f"\n--- VALIDATION ACCURACY (AdaBoost): {val_accuracy * 100:.2f}% ---")
...
print("\n--- Plotting Confusion Matrix (AdaBoost) ---")
cm = confusion_matrix(y_val, y_pred_val)

plt.figure(figsize=(10, 8))
sns.heatmap(cm, annot=True, fmt='d', cmap='Blues',
            xticklabels=le.classes_, yticklabels=le.classes_)
plt.title('Validation Confusion Matrix - AdaBoost', fontsize=16)
plt.ylabel('True Label')
plt.xlabel('Predicted Label')
plt.xticks(rotation=45)
plt.yticks(rotation=0)
plt.tight_layout()
matrix_filename = 'adaboost_confusion_matrix.png'
...
final_model = AdaBoostClassifier(random_state=RANDOM_SEED)
