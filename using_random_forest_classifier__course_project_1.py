# -*- coding: utf-8 -*-
"""Using_Random Forest Classifier_ Course Project 1.ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1qrw2OXhu_hPhT9_DXL63MPZMK50V--A0
"""
...
print(f"\n--- VALIDATION ACCURACY (Random Forest): {val_accuracy * 100:.2f}% ---")
...
plt.title('Validation Confusion Matrix - Random Forest', fontsize=16)
plt.ylabel('True Label')
plt.xlabel('Predicted Label')
plt.xticks(rotation=45)
plt.yticks(rotation=0)
plt.tight_layout()
matrix_filename = 'random_forest_confusion_matrix.png'
...
print(f"\n--- Project Complete (Random Forest) ---")
